...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="page-container">
      ...
      <button className="button" onClick={() => handlePlayClick("pvp")}>
        Play PvP
      </button>
      <button className="button" onClick={() => handlePlayClick("pve")}>
        Play PvE
      </button>
      <button className="button" onClick={() => handlePlayClick("pvmm")}>
        Play Minimax PvE
      </button>
      <button className="button" onClick={handleShowStatsClick}>
        Show Stats
      </button>
      {showStatsModal && (
